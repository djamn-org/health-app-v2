package net.jamnig.health.adapter;
...
import net.jamnig.health.databinding.NoDataViewBinding;
import net.jamnig.health.databinding.RecyclerViewHistoryBinding;
