...
import net.jamnig.health.database.Health;
import net.jamnig.health.database.HealthDao;
import net.jamnig.health.databinding.CalorieInputPopupBinding;
import net.jamnig.health.databinding.FragmentHealthBinding;
